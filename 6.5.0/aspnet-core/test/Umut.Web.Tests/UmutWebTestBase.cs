...
{
    public abstract class UmutWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UmutWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UmutWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UmutDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UmutDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UmutDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UmutDbContext, Task<T>> func)
        {
            T result;
